...
- Added accelerated scans based on macOS file-system changes, alongside an explicit full-scan option.
- Added scan-stage labels, a more conservative time estimate, and a persistent scan stopwatch.
